...
\colorbox{orange!10}{
	\begin{minipage}{\textwidth}
		...
		\cventry{15/10/2015--present}{PhD Candidate}{\footnotesize Ghent University, Faculty of Bioscience engineering, Department of Mathematical Modeling, Statistics and Bioinformatics, BIOMATH group (Model based bioprocess analysis and optimisation)}{}{}{}
		\cvitem{\raisebox{-\height}{\includegraphics[width=0.08\textwidth]{/users/chaimdemulder/Desktop/Doctoraat/Figures/Logos/LogoUGent.pdf}}}
		{\textbf{Project}
			\small Model-based decision support and knowledge build-up for the Wastewater Treatment Plant of Eindhoven, The Netherlands, in close collaboration with the operators (Waterboard De Dommel)}
		\vspace{0.5cm}
		
		\cventry{15/10/2014--15/10/2015}{Research Assistant}{\footnotesize Ghent University, Faculty of Bioscience engineering, Department of Mathematical Modeling, Statistics and Bioinformatics, BIOMATH group (Model based bioprocess analysis and optimisation)}{}{}{}
		\cvitem{\raisebox{-\height}{\includegraphics[width=0.08\textwidth]{/users/chaimdemulder/Desktop/Doctoraat/Figures/Logos/LogoUGent.pdf}}}{\textbf{Projects}\newline \small
			...
			$\bullet$ Construct a model for the simulation of the High Rate Activated Sludge Process, based on two previoulsy described models.}
		\cventry{}{Other responsabilities:}{}{}{}{}
		\cvitem{\raisebox{-\height}{\includegraphics[width=0.1\textwidth]{/users/chaimdemulder/Desktop/Doctoraat/Figures/Logos/LogoBIWA}}}{\small 
			...
			$\circ$ Coordinator of the first and second \href{http://www.b-iwa.be/node/177}{\underline{B-IWA nocturnal}}}
		\cvitem{\raisebox{-\height}{\includegraphics[width=0.08\textwidth]{/users/chaimdemulder/Desktop/Doctoraat/Figures/Logos/IWA}}}{\small
			...
			$\bullet$ Assist in the course Modeling and Control of Wastewater Treatment Plants, given at the Faculty of Bioscience Engineering, Ghent University.}
		...
		\cvitem{\raisebox{-\height}{\includegraphics[width=0.08\textwidth]{/users/chaimdemulder/Desktop/Doctoraat/Figures/Logos/LogoDCWater.png}}}
		...
		\cvitem{\raisebox{-\height}{\includegraphics[width=0.07\textwidth]{/users/chaimdemulder/Desktop/Doctoraat/Figures/Logos/LogoAalto}}}
...
\colorbox{green!10}{
	\begin{minipage}{\textwidth}
		...
		\cvitem{2006-present}{Athletics (recreational and competition), music, climate related, environmental and social issues, Scandinavian culture}
