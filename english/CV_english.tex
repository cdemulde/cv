...
\colorbox{green!10}{
	\begin{minipage}{\textwidth}
		...
		\cvitem{}{\small General support on local level (team management)  and within international IAESTE groups (Western European region). Jobraising and organizing activities for incoming trainees.\normalsize}
...
\begin{center}
	\begin{ganttchart}[
		...
		\gantttitle{2010}{1} \gantttitle{2011}{1} \gantttitle{2012}{2} \gantttitle{2013}{2} \gantttitle{2014}{2} \gantttitle{2015}{2} \gantttitle{2016}{2}\gantttitle{2017}{1}\\
		...
		\textcolor{orange}{\ganttbar[bar2]{PhD Candidate}{11}{13}}\\
		\textcolor{green}{\ganttbar[bar3]{IAESTE Member}{6}{13}}\\
		%\textcolor{green}{\ganttbar[bar3]{IAESTE support}{14}{16}}\\
		%\textcolor{green}{\ganttbar[bar3]{IAESTE Vice President}{14}{16}}\\		
		\textcolor{green}{\ganttbar[bar3]{Athletics}{1}{13}}
		\normalsize
	\end{ganttchart}
\end{center}
