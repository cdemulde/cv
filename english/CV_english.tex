...
\colorbox{orange!10}{
	\begin{minipage}{\textwidth}
		...
		\cventry{15/10/2014--present}{Research Assistant}{Ghent University, Faculty of Bioscience engineering, Department of Mathematical Modeling, Statistics and Bioinformatics, BIOMATH group (Model based bioprocess analysis and optimisation)}{}{}{}
		\cvitem{\raisebox{-\height}{\includegraphics[width=0.12\textwidth]{/users/chaimdemulder/Desktop/Doctoraat/Figures/Logos/LogoUGent.pdf}}}{\textbf{Projects} \small}
		\cvitem{\raisebox{-\height}{\includegraphics[width=0.12\textwidth]{/users/chaimdemulder/Desktop/Doctoraat/Figures/Logos/LogoBIWA}}}{\textbf{Other responsabilities:}\newline \small 
		$\bullet$ Active member of the Belgian Division of the International Water Association (B-IWA): maintenance of \href{http://www.b-iwa.be}{website}, \href{https://www.linkedin.com/groups?mostRecent=&gid=3760023&trk=my_groups-tile-flipgrp}{LinkedIn}- and \href{https://twitter.com/BelgianIWA}{Twitter}-account.\newline
		$\bullet$ Coordinator of the first B-IWA nocturnal (\href{http://www.b-iwa.be/node/177}{www.b-iwa.be/nocturnal}), May 19$^{th}$ 2015.
		}
		\cvitem{\raisebox{-\height}{\includegraphics[width=0.10\textwidth]{/users/chaimdemulder/Desktop/Doctoraat/Figures/Logos/IWA}}}{\small
		$\bullet$ Co-organizer of the second B-IWA nocturnal (), May 18$^{th}$ 2016.\newline
		$\bullet$ Co-organizer of an IWA YWP Workshop (Aug 29 - 30, 2015)\newline
		$\bullet$ Assist in the courses 
		} 
...
\colorbox{green!10}{
	\begin{minipage}{\textwidth}
		...
		\cvitem{}{\small Attending conferences, jobraising, support within regional IAESTE groups (Connect Region), general support. Organizing activities for incoming trainees.\normalsize}
...
\begin{center}
	\begin{ganttchart}[
		...
		\gantttitle{2010}{1} \gantttitle{2011}{1} \gantttitle{2012}{2} \gantttitle{2013}{2} \gantttitle{2014}{2} \gantttitle{2015}{2} \gantttitle{2016}{2}\\
		...
		\textcolor{orange}{\ganttbar[bar2]{Research Assistant}{8}{11}}\\
		\textcolor{orange}{\ganttbar[bar2]{PhD Candidate}{12}{12}}\\
		\textcolor{green}{\ganttbar[bar3]{IAESTE Member}{6}{12}}\\
		%\textcolor{green}{\ganttbar[bar3]{IAESTE support}{14}{16}}\\
		%\textcolor{green}{\ganttbar[bar3]{IAESTE Vice President}{14}{16}}\\		
		\textcolor{green}{\ganttbar[bar3]{Athletics}{1}{12}}
		\normalsize
	\end{ganttchart}
\end{center}
