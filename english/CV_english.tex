...
\colorbox{orange!10}{
	\begin{minipage}{\textwidth}
		...
		$\bullet$ Active YWP member in the board of directors of the Belgian branch of IWA (BIWA), 2015--present\newline
...
\colorbox{green!10}{
	\begin{minipage}{\textwidth}
		...
		%\cvitem{}{\normalsize}
		\cvitem{2014--2015}{\textbf{LC Ghent supporting member \& Summer Reception Officer}: \small Design of PR materials, presenting IAESTE to companies, jobraising. Organizing activities for incoming trainees. }
		%\cvitem{}{\normalsize}
