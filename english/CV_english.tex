...
\colorbox{orange!10}{
	\begin{minipage}{\textwidth}
		...
		\cvitem{\raisebox{-\height}{\includegraphics[width=0.12\textwidth]{./LogoUGent.png}}}{\small
...
\colorbox{green!10}{
	\begin{minipage}{\textwidth}
		...
		\cvitem{\centering\raisebox{-0.4\height}{\includegraphics[width=0.05\textwidth]{./ClimateResponse}}\\}{Spreading facts on Climate Change.\newline}
...
%\subsection{Software}
%\nocitesoftware{*}
%\printbibliography{./CVsoftware.bib}

%\biboptions{sort&compress}
%\bibliographystyle{unsrt} %of unsrt, bibliodutch, apalike, ieeetr, plainnat...
