...
\colorbox{orange!10}{
	\begin{minipage}{\textwidth}
		...
		\cvitem{\raisebox{-\height}{\includegraphics[width=0.1\textwidth]{./LogoBIWA.pdf}}}{\small 
		...
		\cvitem{\raisebox{-\height}{\includegraphics[width=0.08\textwidth]{./LogoDCWater.png}}}
		...
		\cvitem{\raisebox{-\height}{\includegraphics[width=0.07\textwidth]{./LogoAalto}}}
...
\colorbox{green!10}{
	\begin{minipage}{\textwidth}
		...
		\cvitem{\raisebox{-\height}{\includegraphics[width=0.07\textwidth]{./iaeste_logo.jpg}}}{\textbf{IAESTE} \newline(International Association for the Exchange of Students for Technical Experience)}
		\cvitem{2016-2017}{LC Ghent Exchange Coordinator}
		\cvitem{}{\small Board member of the Local Committee of Ghent, day-to-day management of a 25-person team of students. Resposible for international internship exchange and networking, jobraising. \normalsize}
		...
		\cvitem{}{\small Responsible for meeting reports, jobraising. \normalsize}
		
		\cvitem{}{\textbf{Sports and general interests}}
		\cvitem{2006-present}{Athletics (recreational and competition), music, climate related, environmental and social issues, Nordic culture}
